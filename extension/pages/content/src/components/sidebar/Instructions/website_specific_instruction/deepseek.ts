/**
 * DeepSeek-specific instructions for the Gremy Discord Bridge.
 * Mirrors chatgpt.ts — DeepSeek uses the same XML function-call format.
 */
...
6. All other DeepSeek capabilities remain available — the discord_* tools are
